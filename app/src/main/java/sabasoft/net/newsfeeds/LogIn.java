...
import sabasoft.net.newsfeeds.APICalls.HttpGetPosts;
import sabasoft.net.newsfeeds.PushNotification.Push;
...
public class LogIn extends ActionBarActivity {
    ...
    void  login(){
        ...
        try {
            HttpEntity resEntity = new HttpGetPosts(emailId,pasword).getEntity();
            if (resEntity != null) {
